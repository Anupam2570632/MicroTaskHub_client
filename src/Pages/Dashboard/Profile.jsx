...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className=" shadow-lg rounded-2xl p-6 w-full max-w-md bg-[#293538]">
        {/* Profile Image */}
        ...
        <div className="text-center mt-4">
          <h2 className="text-2xl font-bold text-[#acb3b6]">{fullName}</h2>
          <p className="text-gray-500">{email}</p>
        </div>

        {/* Role & Coins */}
        <div className="mt-6 space-y-3 text-[#e9eaea]">
