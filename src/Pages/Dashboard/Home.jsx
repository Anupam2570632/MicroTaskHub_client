...
export default function DashboardHome() {
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl text-[#acb3b6] font-semibold mb-4">Dashboard</h1>

      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {/* Card 1 */}
        <div className="bg-[#2c393c] hover:shadow-xl hover:scale-[1.01] duration-200 shadow-md rounded-lg p-4">
          <div className="flex items-center justify-between pb-2">
            <p className="text-sm text-[#e9eaea] font-medium">Total Earnings</p>
        ...
        <div className="bg-[#2c393c] hover:shadow-xl hover:scale-[1.01] duration-200 shadow-md rounded-lg p-4">
          <div className="flex items-center justify-between pb-2">
            <p className="text-sm text-[#e9eaea] font-medium">Tasks Completed</p>
        ...
        <div className="bg-[#2c393c] hover:shadow-xl hover:scale-[1.01] duration-200 shadow-md rounded-lg p-4">
          <div className="flex items-center justify-between pb-2">
            <p className="text-sm text-[#e9eaea] font-medium">Active Tasks</p>
      ...
      <div className="mt-6">
        <div className="bg-[#2c393c] hover:shadow-xl hover:scale-[1.01] duration-200 shadow-md rounded-lg p-4">
          <div className="mb-2">
            <h2 className="text-lg text-[#e9eaea] font-semibold">Recent Activity</h2>
